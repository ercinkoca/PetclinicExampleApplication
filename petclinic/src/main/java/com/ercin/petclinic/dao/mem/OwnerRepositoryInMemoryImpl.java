package com.ercin.petclinic.dao.mem;
...
public class OwnerRepositoryInMemoryImpl implements OwnerRepository {
	...
	//Veritabanı kullanmadan önce test etmek için bu sınıfı yazdık.
	//Tamamen yazdığımız metotları test etmek için.
	//Hashmap'e ekleyip çıkarıp aratacağız.
	
	public OwnerRepositoryInMemoryImpl() {
		Owner owner1=new Owner();
		owner1.setId(1L);
		owner1.setFirstName("Erçin");
		owner1.setLastName("Koca");
		
		Owner owner2=new Owner();
		owner2.setId(2L);
		owner2.setFirstName("Burak");
		owner2.setLastName("Ağa");
		
		Owner owner3=new Owner();
		owner3.setId(3L);
		owner3.setFirstName("Ece");
		owner3.setLastName("Koca");
		
		Owner owner4=new Owner();
		owner4.setId(4L);
		owner4.setFirstName("Elif");
		owner4.setLastName("Koca");
